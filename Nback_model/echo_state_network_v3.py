...
class SpikingEchoStateNetwork:
    ...
    def __init__(self, n_inputs, n_reservoir, n_outputs, p_rewire,
                 ...
                 A_minus=0.5, tau_plus=50.0, tau_minus=50.0): # 最適化 #tau大きいほど減衰遅くなる
        ...
        # self.input_region_size = n_reservoir // 3
        # self.output_region_size = n_reservoir // 3
        ...
        self.W_input = np.random.rand(self.input_region_size, n_inputs) - 0.5 # input → reserver input region
        self.W_output = np.zeros((n_outputs, self.output_region_size)) # reserver output region → output
